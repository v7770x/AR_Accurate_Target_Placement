...
public class Transform3DBestFit
{
    /// <summary>
    ...
    public Transform3DBestFit(double[,] actuals, double[,] nominals)
    {
    ...
    /// <param name="actuals"></param>
    /// <param name="nominals"></param>
    public Transform3DBestFit(Matrix<double> actuals, Matrix<double> nominals)
    {
        //convert array to Math.NET Matrices
